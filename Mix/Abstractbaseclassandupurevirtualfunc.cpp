...
//  Pure virtual function are used for making abstarct classes //
//  Abstract classes contains atleast one virtaul function //
//  Abstract class is that class which is not used to create objects //
//  Deigned for masking other classes //
